...
::: {.column width="60%"}
<img src="images/gtsummary-hex.png" alt="drawing" width="70%"/>
:::
...
`r fontawesome::fa("bluesky", fill = fa_fill)` [@pipinghotdata.com](https://bsky.app/profile/pipinghotdata.com)
...
::: {.column width="40%"}
![](images/shannon-pileggi-circle.png)
:::
:::
