...
Recording available on [youtube](https://youtu.be/Qo2HwDxw1fM?si=ix1vSmEn_1aL6OZ1) (1 hour 50 minutes).

## Prerequisites

The workshop assumes a familiarity with R and the tidyverse.
...
- [ ] Run `install.packages(c("tidyverse", "gtsummary"))` in your local session.
...
![](images/shannon.png){style="float:left;padding: 0 10px 0 0;" fig-alt="Headshot of Shannon Pileggi" width="150"}
...
<br>
[`r fontawesome::fa("link", fill = "#606060")`](https://www.pipinghotdata.com/)
[`r fontawesome::fa("bluesky", fill = "#606060")`](https://bsky.app/profile/pipinghotdata.com)
[`r fontawesome::fa("linkedin", fill = "#606060")`](https://www.linkedin.com/in/shannon-m-pileggi/)
[`r fontawesome::fa("github", fill = "#606060")`](https://github.com/shannonpileggi)
